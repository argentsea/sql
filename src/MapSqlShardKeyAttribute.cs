...
namespace ArgentSea.Sql
{
    public class MapSqlShardKeyAttribute : MapShardKeyAttribute
    {
        ...
        public MapSqlShardKeyAttribute(string shardIdName, char origin, string recordIdName)
            : base(new MapToSqlSmallIntAttribute(shardIdName, false), origin, recordIdName, null, null, null, true) { }
        ...
        public MapSqlShardKeyAttribute(char origin, string recordIdName, bool isRecordIdentifier)
        ...
        /// <param name="recordIdName">The name of the data column, which must exactly match the database attribute.</param>
        /// <param name="isRecordIdentifier">A optional value which indicates whether the property is the record identifier. Defaults to True if not set.</param>
        public MapSqlShardKeyAttribute(string shardIdName, char origin, string recordIdName, bool isRecordIdentifier)
            : base(new MapToSqlSmallIntAttribute(shardIdName, false), origin, recordIdName, null, null, null, isRecordIdentifier) { }
        ...
        public MapSqlShardKeyAttribute(string shardIdName, char origin, string recordIdName, string childIdName)
            : base(new MapToSqlSmallIntAttribute(shardIdName, false), origin, recordIdName, childIdName, null, null, true) { }
        ...
        /// <param name="childIdName">The name of the optional 2nd data column, if a compound key, which must exactly match the corresponding database attribute.</param>
        /// <param name="isRecordIdentifier">A optional value which indicates whether the property is the record identifier. Defaults to True if not set.</param>
        public MapSqlShardKeyAttribute(char origin, string recordIdName, string childIdName, bool isRecordIdentifier)
        ...
        /// <param name="childIdName">The name of the optional 2nd data column, if a compound key, which must exactly match the corresponding database attribute.</param>
        /// <param name="isRecordIdentifier">A optional value which indicates whether the property is the record identifier. Defaults to True if not set.</param>
        public MapSqlShardKeyAttribute(string shardIdName, char origin, string recordIdName, string childIdName, bool isRecordIdentifier)
            : base(new MapToSqlSmallIntAttribute(shardIdName, false), origin, recordIdName, childIdName, null, null, isRecordIdentifier) { }
        ...
        public MapSqlShardKeyAttribute(string shardIdName, char origin, string recordIdName, string childIdName, string grandChildIdName)
            : base(new MapToSqlSmallIntAttribute(shardIdName, false), origin, recordIdName, childIdName, grandChildIdName, null, true) { }
        ...
        /// <param name="grandChildIdName">The name of the optional 3rd data column, if a compound key, which must exactly match the corresponding database attribute.</param>
        /// <param name="isRecordIdentifier">A optional value which indicates whether the property is the record identifier. Defaults to True if not set.</param>
        public MapSqlShardKeyAttribute(char origin, string recordIdName, string childIdName, string grandChildIdName, bool isRecordIdentifier)
        ...
        /// <param name="grandChildIdName">The name of the optional 3rd data column, if a compound key, which must exactly match the corresponding database attribute.</param>
        /// <param name="isRecordIdentifier">A optional value which indicates whether the property is the record identifier. Defaults to True if not set.</param>
        public MapSqlShardKeyAttribute(string shardIdName, char origin, string recordIdName, string childIdName, string grandChildIdName, bool isRecordIdentifier)
            : base(new MapToSqlSmallIntAttribute(shardIdName, false), origin, recordIdName, childIdName, grandChildIdName, null, isRecordIdentifier) { }
        ...
        public MapSqlShardKeyAttribute(string shardIdName, char origin, string recordIdName, string childIdName, string grandChildIdName, string greatGrandChildIdName)
            : base(new MapToSqlSmallIntAttribute(shardIdName, false), origin, recordIdName, childIdName, grandChildIdName, greatGrandChildIdName, true) { }
        ...
        /// <param name="greatGrandChildIdName">The name of the optional 4th data column, if a compound key, which must exactly match the corresponding database attribute.</param>
        /// <param name="isRecordIdentifier">A optional value which indicates whether the property is the record identifier. Defaults to True if not set.</param>
        public MapSqlShardKeyAttribute(char origin, string recordIdName, string childIdName, string grandChildIdName, string greatGrandChildIdName, bool isRecordIdentifier)
        ...
        /// <param name="greatGrandChildIdName">The name of the optional 4th data column, if a compound key, which must exactly match the corresponding database attribute.</param>
        /// <param name="isRecordIdentifier">A optional value which indicates whether the property is the record identifier. Defaults to True if not set.</param>
        public MapSqlShardKeyAttribute(string shardIdName, char origin, string recordIdName, string childIdName, string grandChildIdName, string greatGrandChildIdName, bool isRecordIdentifier)
            : base(new MapToSqlSmallIntAttribute(shardIdName, false), origin, recordIdName, childIdName, grandChildIdName, greatGrandChildIdName, isRecordIdentifier) { }
    }
}
